...
"""
    ...
    def collaborate_on_topic(self, 
        ...
        """
        prompt = f"""Please orchestrate a collaborative investigation of this physics topic: {topic}

Collaboration mode: {mode}
{"Additional context: " + context if context else ""}

Coordinate between the Physics Expert and Hypothesis Generator to:
1. Analyze the topic from both rigorous and creative perspectives
2. Generate novel insights and hypotheses
3. Validate ideas with scientific principles
4. Synthesize findings into a comprehensive response
5. Identify promising directions for further research

Ensure both agents contribute their unique expertise while maintaining scientific rigor.
"""
